...
namespace jogoXadrez.xadrez
{
    public class PartidaXadrez
    {
        ...
        public Peca executarMovimetno(Posicao origem, Posicao destino)
        {
        ...
        public void desfazerMovimiento(Posicao origem, Posicao destino, Peca pecaCapturada)
        {
        ...
        public void realizaJogada(Posicao origem, Posicao destino)
        {
            ...
            Peca pecaCapturada = executarMovimetno(origem, destino);

            if(estaEmXeque(jogadorAtual)){
                desfazerMovimiento(origem, destino, pecaCapturada);
